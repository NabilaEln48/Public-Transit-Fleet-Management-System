    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm">
        <div class="container">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link" href="operator.jsp">Logout</a>
                                                ...
                                                <tr>
                                                    <td class="p-3">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <strong class="d-block">${vehicle.vehicleNumber}</strong>
        ...
        <div class="row g-4 mt-4">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0 fw-bold">
                            <i class="fas fa-bolt me-2"></i>Quick Actions & Reports
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
                            <div class="col">
                                <a href="GPSTrackingServlet?action=report" class="btn btn-outline-primary h-100 d-flex align-items-center justify-content-center flex-column py-3">
                                    <i class="fas fa-chart-line fa-2x mb-2"></i>
                                    <span>Location Report</span>
                                </a>
                            </div>
                            <div class="col">
                                <a href="GPSTrackingServlet?action=breaks" class="btn btn-outline-warning h-100 d-flex align-items-center justify-content-center flex-column py-3">
                                    <i class="fas fa-coffee fa-2x mb-2"></i>
                                    <span>Breaks Report</span>
                                </a>
                            </div>
                            <div class="col">
                                <a href="VehicleServlet?action=list" class="btn btn-outline-info h-100 d-flex align-items-center justify-content-center flex-column py-3">
                                    <i class="fas fa-truck fa-2x mb-2"></i>
                                    <span>Manage Vehicles</span>
                                </a>
                            </div>
                            <div class="col">
                                <button class="btn btn-outline-success h-100 w-100 d-flex align-items-center justify-content-center flex-column py-3" onclick="exportData()">
