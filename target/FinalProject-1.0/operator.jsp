...
<head>
    <meta charset="UTF-8">
    <title>Operator Dashboard - PTFMS</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <!-- Navigation Bar -->
    <nav class="navbar">
        <div class="app-title">PTFMS - Operator Dashboard</div>
        <div class="user-role">Logged in as: <%= role.toUpperCase() %></div>
        ...
        <% if ("operator".equalsIgnoreCase(role)) { %>
            <div class="section">
                ...
                <div class="card-grid">
                    ...
                    <%-- CORRECTED: Changed "View Reports" to specifically view Operator Service Logs --%>
                    <div class="card"><a href="${ctx}/FrontendController?action=OperatorServiceLogs">View My Service Logs</a></div>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="card-grid">
                    ...
                    <div class="card"><a href="${ctx}/maintenanceOverview.jsp">Maintenance Overview</a></div>
                       <div class="card"><a href="${ctx}/GPSTrackingServlet">GPS Logs</a></div>
                </div>
            </div>
        <% } %>
    </div>
